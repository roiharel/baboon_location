...
")
  ...
  saveWidget(m, paste0('plots/htmls/','/baboon_interactive_map.html'), selfcontained = TRUE)
...
")
    ...
    # Save the map as an HTML file
    saveWidget(m, paste0('plots/htmls/','/baboon_night_interactive_map.html'), selfcontained = TRUE)
  }
...
#     m
#     # Save the map as an HTML file
#     saveWidget(m, paste0('plots/htmls/',as.Date(Sys.Date(), format = "%Y%m%d"),'/baboon_interactive_group_map.html'), selfcontained = TRUE)
#     
#   }